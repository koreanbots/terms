...
- 모든 욕설, 모욕, 인신공격, 비방, 비난 등과 같은 상대의 명예를 훼손하는 행위
- 특정 단체나 집단 혹은 개인에 대한 비난과 인신공격, 일반화 및 인종차별 등의 행위
- 대화의 흐름에 어긋난 유저 멘션 행위
- 모든 범주의 음란물, 성행위, 유사 성행위, 성인용품의 직/간접 표현 및 언급, 관련 사이트 등의 언급, 음담패설
- 사회적 가치 및 윤리에 반하거나 미풍양속을 저해하는 대화 주제
- 대한민국 법에 저촉되거나 디스코드 약관을 위반하는 주제
- 대화의 흐름을 흐리는 특정한 설정(콘셉트)을 세우는 행위

- 정치, 사회, 종교와 관련된 언급 및 관련 인물의 언급 **[경고~영구 뮤트]**

### 홍보 [경고 ~ 차단]

- 노골적, 지속적으로 ``디스코드 봇``, ``디스코드 서버``, ``팀`` 등을 홍보하는 행위
- ``디스코드 서버 초대링크``, ``사이트 링크``, ``타 커뮤니티 링크``등을 기재하여 **채용**, **서버 참가** 등에 대한 홍보성을 띄는 행위
- 외주, 커미션 등을 받거나 요청하는 행위
